...
from util.DatasetGennerate import ClusteringDataset, MeaningfulClusteringDataset, SemanticClusteringDataset, get_dataset_big_config
...
def main(args):
    ...
    train_loader, val_loader, test_loader = get_dataset_big_config(args, SizeofDataset = args.get('SizeofDataset', 5000))
...
if __name__ == "__main__":
    # args = parse_args()
    args = load_yaml_config('JCompany_W15_J400_5000.yaml')
