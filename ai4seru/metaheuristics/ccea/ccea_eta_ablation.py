# -*- coding: utf-8 -*-
"""
ETA ablation CCEA supporting worker-only, batch-only, and joint guidance.
...
class CCEA:
    ...
    def run(self, Pop_Size: Optional[int] = None, iteration_stop: int = 10000, stop_time = 1000) -> Tuple[SeruFormation, SeruSchedule, Solution]:
